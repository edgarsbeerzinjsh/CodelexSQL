...
describe("Foreign Keys", () => {
  ...
  it(
    ...
    async done => {
      const genreId = 5;
      const query = selectGenreById(genreId);
      try {
  ...
  it(
    ...
    async done => {
      const directorId = 7;
      const query = selectDirectorById(directorId);
      try {
        await db.delete(query);
      } catch (e) {}
  ...
  it(
    ...
    async done => {
      const actorId = 10;
      const query = selectActorById(actorId);
      try {
        await db.delete(query);
      } catch (e) {}
  ...
  it(
    ...
    async done => {
      const keywordId = 12;
      const query = selectKeywordById(keywordId);
      try {
        await db.delete(query);
      } catch (e) {}
  ...
  it(
    ...
    async done => {
      const companyId = 12;
      const query = selectProductionCompanyById(companyId);
      try {
        await db.delete(query);
      } catch (e) {}
  ...
  it(
    ...
    async done => {
      const movieId = 100;
      const query = selectMovieById(movieId);
      try {
        await db.delete(query);
      } catch (e) {}
